package net.sdvn.nascommon.service;//package com.eli.oneos.service;
//
...
//       Logger.LOGD(TAG, "=====Backup Service On Create=====");
//
...
//            Logger.LOGE(TAG, "Do not open auto backup photo");
//            return;
//        }
...
//       Logger.LOGD(TAG, "======Start Backup Thread");
//    }
//
...
//        super.onDestroy();
//       Logger.LOGD(TAG, "=====Backup Service On Destroy=====");
//        stopUpload();
//    }
//}
