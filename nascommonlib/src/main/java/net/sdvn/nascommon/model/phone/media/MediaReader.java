...
public class MediaReader {
     ...
     */
    @WorkerThread
    private void scanImageFile(@NonNull Map<String, AlbumFolder> albumFolderMap, @NonNull AlbumFolder allFileFolder) {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                if (albumFolder != null)
                    ...
                    albumFolder.addAlbumFile(imageFile);
                    String pathParent = path.substring(0, path.lastIndexOf(File.separator));
                    albumFolder.setPath(pathParent);
     ...
     */
    @WorkerThread
    private void scanVideoFile(@NonNull Map<String, AlbumFolder> albumFolderMap, @NonNull AlbumFolder allFileFolder) {
        ContentResolver contentResolver = mContext.getContentResolver();
    ...
    public ArrayList<AlbumFolder> getAllImage() {
        ...
        allFileFolder.setName(mContext.getString(R.string.file_type_pic));
    ...
    public ArrayList<AlbumFolder> getAllVideo() {
        ...
        AlbumFolder allFileFolder = new AlbumFolder();
        allFileFolder.setChecked(true);
        allFileFolder.setName(mContext.getString(R.string.file_type_video));
    ...
    public ArrayList<AlbumFolder> getAllMedia() {
        ...
        AlbumFolder allFileFolder = new AlbumFolder();
        allFileFolder.setChecked(true);
        allFileFolder.setName(mContext.getString(R.string.all_images_videos));
