 ...
 */
public class OneOSListCameraDateAPI extends BaseAPI {
    private static final String TAG = OneOSListCameraDateAPI.class.getSimpleName();

    private OnListCameraDateListener listener;

    public OneOSListCameraDateAPI(@NonNull LoginSession loginSession) {
        super(loginSession, OneOSAPIs.FILE_API, "camera");
    }

    public void setListener(OnListCameraDateListener listener) {
        this.listener = listener;
    }

    public void list(String cameraPath) {
        Map<String, Object> params = new HashMap<>();
//        url = genOneOSAPIUrl(OneOSAPIs.FILE_API);
        params.put("cmd", "date");
        params.put("path", cameraPath);
        setParams(params);
    ...
    public interface OnListCameraDateListener {
        void onStart(String url);

        void onSuccess(String url, JSONArray dateList);
