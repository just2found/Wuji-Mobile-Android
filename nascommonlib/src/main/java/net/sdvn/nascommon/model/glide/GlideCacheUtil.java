...
public class GlideCacheUtil {
    ...
    public String getCacheSize() {
        try {
          //  String path = MyApplication.getAppContext().getExternalCacheDir()+"/"+GlideCacheConfig.GLIDE_CACHE_DIR;
            String path = String.valueOf(Utils.getApp().getExternalCacheDir());
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(Utils.getApp().getCacheDir() + "/" + GlideCacheConfig.GLIDE_CACHE_DIR, true);
    }
