package net.sdvn.nascommon.model.upgrade;//package com.eli.oneos.model.upgrade;
//
...
//import com.eli.oneos.db.SPHelper;
//import com.eli.oneos.model.http.HttpRequest;
//import com.eli.oneos.model.http.OnHttpRequestListener;
//import com.eli.oneos.model.log.Logger.Level;
//import com.eli.oneos.model.log.Logger.Logd;
...
//                    Logger.p(Level.DEBUG, Logd.DEBUG, TAG, "Latest App Version: " + latestVersion);
//                    String curVersion = AppVersionUtils.getAppVersion();
//                    String ignoreVersion = SPHelper.get(SharedPrefersKeys.IGNORE_APP_VERSION_NO, null);
...
//                Logger.LOGE(TAG, "ErrorNo: " + errorNo + ", ErrorMsg: " + strMsg + "http code " + httpCode);
//            }
//        });
//        httpRequest.setParseResult(false);
//        httpRequest.get(URL_VERSION);
//    }
//
...
//
//                        @Override
//                        public void onItemClick(boolean isPositiveBtn) {
//                            if (isPositiveBtn) {
...
//                            } else if (index == 2) {
//                                // ignore this version
//                                SPHelper.put(SharedPrefersKeys.IGNORE_APP_VERSION_NO, serverVersion);
//                            }
//                        }
//                    });
//        }
...
//                e.printStackTrace();
//                newAppFile = null;
//                Logger.LOGE(TAG, "download new app exception");
//            }
//
...
//                    total += len;
//                    if (progress != null) {
//                        String numberFormat = FileUtils.fmtFileSize(total) + "/" + FileUtils.fmtFileSize(conn.getContentLength());
