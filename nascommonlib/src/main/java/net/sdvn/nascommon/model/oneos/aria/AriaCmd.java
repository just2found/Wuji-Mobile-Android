...
public class AriaCmd {
    ...
    private void initJsonArray() throws IOException, JSONException {
        ...
        if (this.action == AriaAction.ADD_TORRENT) {
            ...
            // Logd.d(TAG, "JSON Param: " + this.paramsArray.toString());
        }
    }
    ...
    private void initAriaMethod() {
        // Logd.d(TAG, "---Init Aria Method by Action---");
    ...
    public String toJsonParam() throws JSONException, IOException {
        ...
        Logger.p(Logger.Level.DEBUG, Logger.Logd.DEBUG, TAG, "Aria Json: " + params.toString());
    ...
    public void setContents(@Nullable String[] content) {
        if (null != content) {
