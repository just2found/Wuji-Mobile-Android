package net.sdvn.nascommon.widget.lv;
...
public abstract class LVBase extends View {
    ...
    public float getFontlength(@NonNull Paint paint, @NonNull String str) {
        Rect rect = new Rect();
        paint.getTextBounds(str, 0, str.length(), rect);
        return rect.width();
    }

    public float getFontHeight(@NonNull Paint paint, @NonNull String str) {
        Rect rect = new Rect();
        paint.getTextBounds(str, 0, str.length(), rect);
        return rect.height();
    ...
    public float getFontHeight(@NonNull Paint paint) {
