...
public class AnimCircleProgressBar extends View {
    ...
    public AnimCircleProgressBar(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class CartoomEngine {
        ...
        public synchronized void startCartoom() {
            ...
            Logger.LOGD("Circle Progress", "Start Cartoom");
        ...
        public synchronized void setAnimParameter(int progress) {
            ...
            Logger.LOGE(VIEW_LOG_TAG, "--------Target Progress: " + this.mTargetProgress);
        }
    }
