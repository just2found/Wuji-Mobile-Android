package net.sdvn.nascommon.widget;//package net.sdvn.nascommon.widget;
//
...
//
//        mListView = view.findViewById(R.id.listview_spinner);
...
//
//                holder.mTitleTxt = convertView.findViewById(R.id.txt_spinner_title);
//                holder.mRightIBtn = convertView.findViewById(R.id.ibtn_spinner_right);
...
//            }
//            holder.mTitleTxt.setTitleText(item.title);
//
//            if (item.deletable) {
