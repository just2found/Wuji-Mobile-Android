...
public class ClearEditText extends EditText implements OnFocusChangeListener, TextWatcher {
    ...
    public ClearEditText(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle,0);

    }
    public ClearEditText(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        mClearDrawable.setBounds(0, 0, (int) dp2px(getContext(),24),
                (int) dp2px(getContext(),24));
        // 默认设置隐藏图标
