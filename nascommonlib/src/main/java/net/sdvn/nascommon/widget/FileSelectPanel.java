...
public class FileSelectPanel extends RelativeLayout {
    ...
    private TextView mCancelBtn, mSelectBtn;
    ...
    public FileSelectPanel(Context context, AttributeSet attrs) {
        ...
        mTitleTxt = view.findViewById(R.id.text_count);
        mTitleTxt.setOnTouchListener(new OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                return true;
            }
        });
        mCancelBtn = view.findViewById(R.id.btn_select_cancel);
        mSelectBtn = view.findViewById(R.id.btn_select_all);
