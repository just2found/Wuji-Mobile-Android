...
public class AppConstants {
    ...
    @NotNull
    public static final String REGEX_UPLOAD_TMP_FILE = ".*\\.upload([A-Za-z0-9]{32})|.*\\.tmpdata|.*\\.upload";
    @NotNull
    public static final String SP_SHOW_REMARK_NAME = "sp_show_remark_name";
    @NotNull
    ...
    public static final String DEFAULT_APP_ROOT_DIR_NAME = "/" + Utils.getApp().getString(R.string.app_name);
    ...
    public static final String PHOTO_DATE_UNKNOWN = Utils.getApp().getString(R.string.unknown_photo_date);
