...
public class ActivityItemLayout1 extends RelativeLayout {
    ...
    public ActivityItemLayout1(Context context) {
        this(context, null);
    }

    public ActivityItemLayout1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ActivityItemLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        content = (RelativeLayout) View.inflate(context, R.layout.item_activity_layout1, this);
        ...
        if (ial_background_radius_top) {
            ...
            content.setBackground(context.getResources().getDrawable(R.drawable.bg_button_white_radius_top_14));
        } else {
