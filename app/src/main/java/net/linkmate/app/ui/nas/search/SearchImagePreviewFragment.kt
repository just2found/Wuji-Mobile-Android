 ...
 */
class SearchImagePreviewFragment : BaseImagePreviewFragment() {
    private val fileSearchViewModel by viewModels<FileSearchViewModel>({ requireParentFragment() }, { NasAndroidViewModel.ViewModeFactory(requireActivity().application, getDevId()) })
