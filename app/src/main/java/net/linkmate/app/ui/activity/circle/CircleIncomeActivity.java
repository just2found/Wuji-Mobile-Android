...
public class CircleIncomeActivity extends BaseActivity implements HttpLoader.HttpLoaderStateListener {
            ...
            public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                if (view.getId() == R.id.idfd_tv_title) {
                    if (options1Items.size() != 0 && options2Items.size() != 0) {
                        pvOptions = new OptionsPickerBuilder(CircleIncomeActivity.this, new OnOptionsSelectListener() {
                            @Override
                            public void onOptionsSelect(int options1, int option2, int options3, View v) {
                                lastVaildMonth = options1Items.get(options1)
                                        + "-"
                                        + FormatUtils.monthFormatToNumber(CircleIncomeActivity.this,
                        ...
                        try {
                            ...
                            month = FormatUtils.monthFormatToEn(CircleIncomeActivity.this, month);
    ...
    private void initTotal() {
        ...
        loader.setParams(checkedDevId, peroid, "", 1, 24);
    ...
    private void initData() {
        ...
        loader.setHttpLoaderStateListener(this);
        loader.setParams(checkedDevId, lastVaildMonth, currPage, pageSize);
        loader.executor(new MyOkHttpListener<DevFlowDetailList>() {
            @Override
            public void error(Object tag, GsonBaseProtocol baseProtocol) {
                super.error(tag, baseProtocol);
            ...
            public void success(Object tag, DevFlowDetailList data) {
                ...
                if (adapterData.size() == 0 && hasMoreMonth) {
                    initData();
        ...
        if (!DevManager.getInstance().isInitting()) {
            ...
            window.setOnDismissListener(new PopupWindow.OnDismissListener() {
                ...
                public void onDismiss() {
                    WindowUtil.hintShadow(CircleIncomeActivity.this);
                }
            });
