...
public class PriorityBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable {
    ...
    private static final long serialVersionUID = 3560298655601866005L;
    /**
    ...
    private synchronized E opQueue(@Nullable Node<E> node) {
        if (node == null) {
            return _dequeue();
        } else {
            _enqueue(node);
    ...
    private void _enqueue(@NonNull Node<E> node) {
        boolean added = false;
    ...
    public boolean offer(@Nullable E e, long timeout, TimeUnit unit) throws InterruptedException {
     ...
     */
    void unlink(@NonNull Node<E> p, @NonNull Node<E> trail) {
