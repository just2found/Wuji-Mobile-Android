...
public class HttpsUtils {
    ...
    public static HostnameVerifier SafeHostnameVerifier = new HostnameVerifier() {
        @Override
        public boolean verify(String hostname, SSLSession session) {
            return hostname.contains("memenet.net") || hostname.contains("izzbie.com");
        }
    };
    ...
    @NonNull
    private static SSLParams getSslSocketFactoryBase(@Nullable X509TrustManager trustManager, InputStream bksFile, String password, InputStream... certificates) {
    ...
    public static class SafeTrustManager implements X509TrustManager {
        ...
        public SafeTrustManager(InputStream ins) {
            try {
                TrustManager[] trustManagers = prepareTrustManager(ins);
        ...
        @Override
        public void checkClientTrusted(X509Certificate[] chain, String authType) {
            Timber.d("checkClientTrusted %s", authType);
        }

        @Override
        public void checkServerTrusted(X509Certificate[] chain, String authType) {
            Timber.d("checkServerTrusted %s", authType);
        }
