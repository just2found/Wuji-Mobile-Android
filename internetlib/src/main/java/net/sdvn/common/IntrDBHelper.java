...
import net.sdvn.common.vo.MyObjectBox;
...
public class IntrDBHelper {
    ...
    private static final String DB_DIR_NAME = "sdvnapi";
    ...
    private static boolean DEBUG = BuildConfig.DEBUG||BuildConfig.isTestOnly ;
