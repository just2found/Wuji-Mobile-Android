...
public final class StatusBarUtils {
    ...
    @NonNull
    public static Builder from(@NonNull Dialog dialog) {
        return new Builder().setWindow(dialog);
    }

    @NonNull
    public static Builder from(@NonNull Window window) {
    ...
    public static int getStatusBarOffsetPx(@NonNull Context context) {
        if (isLessKitkat()) {
            return 0;
        }
    ...
    @IntRange(from = 0, to = 75)
    public static int getNavigationBarOffsetPx(@NonNull Context context) {
        if (isLessKitkat()) {
            return 0;
        }
        Context appContext = context.getApplicationContext();
    ...
    private void processActionBar(@Nullable final View v) {
