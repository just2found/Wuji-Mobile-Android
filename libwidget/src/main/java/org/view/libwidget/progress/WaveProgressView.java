...
public class WaveProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
       ...
       // float bottomTextY = height * 5 / 7.0f + textRect.height() / 2.0f;
        ...
        bottomPaint.setColor(centerTextY-(bottomTextSize/2) > proHeight+textRect.height() ? (submergedTextColor == 0xffffff0 ? centerTextColor : submergedTextColor) : centerTextColor);
